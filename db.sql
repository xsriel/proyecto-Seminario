...
create table rutinas(idRutinas int primary key auto_increment, tituloRutina varchar(100), descripcionrutina varchar(255));
create table dietas(idDietas int primary key auto_increment, tituloDietas varchar(100), descripciondieta varchar(255));
